...
public class TestDefaultRules extends AbstractRuleTest {
    @NotNull
    @Override
    protected Message createMessage(int index, @NotNull Message.Builder builder) {
        return (index % 4 == 0
    ...
    @Override
    protected @NotNull List<IRule> createDefaultRules() {
