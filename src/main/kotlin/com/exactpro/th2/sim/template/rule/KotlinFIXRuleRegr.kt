...
class KotlinFIXRuleRegr(field: Map<String, Value>) : MessageCompareRule() {
    ...
    override fun handleTriggered(incomeMessage: Message): MutableList<Message> {
        ...
        // Generator ER
            ...
            "01" -> {
                ...
                val anyExecutionReport = message("ExecutionReport")
                        .addFields(
                                "TimeInForce", "-0",
                                "TradingParty", repeating1,
                                "TradingParty", repeating2,
                                ...
                                "OrderID", "-456",
                                "ExecID", "-123",
                                "Text", "Simulate' wrong message"
                        )
                result.add(anyExecutionReport.build())
            }
        }
        return result
    }
